...
plt1 = axMap.imshow(
        rmse, cmap="rainbow", origin="lower", extent=[-180, 180, -90, 90], vmin=0, vmax=1
)
...
plt1 = axMap.imshow(
    r2, cmap="rainbow", origin="lower", extent=[-180, 180, -90, 90], vmin=0, vmax=1
)
m.drawcoastlines(linewidth=0.5)
m.fillcontinents(color="gray")
# axMap.set(xlim=[-180,180], ylim=[-90,90])
...
plt1 = axMap.imshow(
    pearson, cmap="rainbow", origin="lower", extent=[-180, 180, -90, 90], vmin=0, vmax=1
)
m.drawcoastlines(linewidth=0.5)
m.fillcontinents(color="gray")
# axMap.set(xlim=[-180,180], ylim=[-90,90])

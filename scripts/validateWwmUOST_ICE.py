...
rawSatDataDir = '/work/opa/lm09621/data/waves/satData/Globwave'
...
crsSatDataDir = '/work/opa/lm09621/data/waves/satData/crsSatData'
...
# time interval 
startDate, endDate = datetime(2000, 2, 1), datetime(2000, 3, 31)
...
if doCoarsenSatData:
 ...
 # You can do this once, then you can disable the coarseining, unless you want to change latdelta, or the time extent of the sat data
  latdelta = 0.4
  coarsenSatData(rawSatDataDir, crsSatDataDir, startDate, endDate, latdelta, areaRectangles)
